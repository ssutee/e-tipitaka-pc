...
THAI_WATNA_DB = os.path.join(RESOURCES_DIR, 'thaiwn-v8.sqlite')
THAI_POCKET_BOOK_DB = os.path.join(RESOURCES_DIR, 'thaipb-v21.sqlite')
...
PALI_SIAM_NEW_DB = os.path.join(RESOURCES_DIR, 'palinew-v2.sqlite')

PALI_DICT_DB = os.path.join(RESOURCES_DIR, 'p2t_dict_v5.sqlite')
